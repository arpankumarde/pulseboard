...
import { ArrowRight, BarChart3, Calendar, CheckCircle2, Clock, Zap } from "lucide-react";
  ...
  return (
    <section className="px-2">
      <div className="relative isolate overflow-hidden bg-white">
        <div className="absolute inset-0 -z-10 bg-[radial-gradient(45rem_50rem_at_top,var(--color-blue-100),white)] opacity-20" />
        ...
        <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-8">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:pt-8">
            ...
            <p className="mt-6 text-lg leading-8 text-neutral-600">
              Pulseboard is the precision tracker for solo builders. Log sessions, analyze velocity,
              and optimize your workflow without the fluff.
            </p>
            <div className="mt-10 flex items-center gap-x-6">
              <Button size="lg" className="shadow-xl shadow-blue-200/50" asChild>
          ...
          <div className="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mt-24 lg:mr-0 lg:max-w-none lg:flex-none xl:ml-32">
            <div className="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
              <div className="-m-2 rounded-sm bg-neutral-900/5 p-2 ring-1 ring-inset ring-neutral-900/10 lg:-m-4 lg:p-4">
                <div className="shadow-2xl ring-1 ring-neutral-900/10 bg-white p-6 w-[350px] sm:w-[600px] md:w-[500px]">
                  <div className="space-y-6">
                    <div className="flex items-center justify-between border-b border-neutral-100 pb-4">
                      <div className="space-y-1">
                        <h3 className="text-lg font-bold text-neutral-900">Today's Focus</h3>
                        <p className="text-sm text-neutral-500">Tue, Oct 24</p>
                      </div>
                      <div className="text-right">
                        <p className="text-2xl font-bold text-primary">4h 15m</p>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between p-4 bg-neutral-50 border-l-4 border-primary">
                        <div>
                          <p className="text-sm font-bold text-neutral-900">API Development</p>
                          <p className="text-xs text-neutral-500">Coding</p>
                        </div>
                        <span className="text-sm font-semibold text-neutral-700">90m</span>
                      </div>
                      <div className="flex items-center justify-between p-4 bg-neutral-50 border-l-4 border-neutral-700">
                        <div>
                          <p className="text-sm font-bold text-neutral-900">Blog Post Draft</p>
                          <p className="text-xs text-neutral-500">Writing</p>
                        </div>
                        <span className="text-sm font-semibold text-neutral-700">45m</span>
                      </div>
                      <div className="flex items-center justify-between p-4 bg-neutral-50 border-l-4 border-neutral-400 opacity-60">
                        <div>
                          <p className="text-sm font-bold text-neutral-900">React Hooks</p>
                          <p className="text-xs text-neutral-500">Learning</p>
                        </div>
                        <span className="text-sm font-semibold text-neutral-700">120m</span>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div className="bg-white py-24 sm:py-32 border-t border-neutral-100" id="features">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-primary">Build Better Habits</h2>
            <p className="mt-2 text-3xl font-bold tracking-tight text-neutral-900 sm:text-4xl">
              Everything you need to stay consistent
            </p>
            <p className="mt-6 text-lg leading-8 text-neutral-600">
              Most tools are too complex for solo builders. Pulseboard strips away the noise and
              gives you exactly what you need to track your deep work.
            </p>
          </div>
